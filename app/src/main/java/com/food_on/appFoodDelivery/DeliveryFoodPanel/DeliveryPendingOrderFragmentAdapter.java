package com.food_on.appFoodDelivery.DeliveryFoodPanel;
...
import com.food_on.appFoodDelivery.ReusableCode.ReusableCodeForAll;
import com.food_on.appFoodDelivery.SendNotification.APIService;
import com.food_on.appFoodDelivery.SendNotification.Client;
import com.food_on.appFoodDelivery.SendNotification.Data;
import com.food_on.appFoodDelivery.SendNotification.MyResponse;
import com.food_on.appFoodDelivery.SendNotification.NotificationSender;
...
public class DeliveryPendingOrderFragmentAdapter extends RecyclerView.Adapter<DeliveryPendingOrderFragmentAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DeliveryPendingOrderFragmentAdapter.ViewHolder holder, int position) {
        ...
        holder.grandtotalprice.setText("Grand Total: $ " + deliveryShipOrders1.getGrandTotalPrice()+" VND");
